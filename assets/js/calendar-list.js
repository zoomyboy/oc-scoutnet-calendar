...
+function ($) { "use strict";
    ...
    CalendarPage.prototype = Object.create(BaseProto)
    ...
    CalendarPage.prototype.registerHandlers = function() {
        ...
        $(document).on('click', '#calendar-side-panel form button[data-control=delete-object], #calendar-side-panel form button[data-control=delete-template]',
     ...
     */
    CalendarPage.prototype.handleMtimeMismatch = function (form) {
        var $form = $(form)
     ...
     */
    CalendarPage.prototype.reloadForm = function($form) {
        var data = {
     ...
     */
    CalendarPage.prototype.updateModifiedCounter = function() {
        var counters = {
     ...
     */
    CalendarPage.prototype.onTabShown = function(e) {
     ...
     */
    CalendarPage.prototype.onAllTabsClosed = function() {
     ...
     */
    CalendarPage.prototype.onTabClosed = function() {
     ...
     */
    CalendarPage.prototype.onAjaxError = function(event, context, message, data, jqXHR) {
     ...
     */
    CalendarPage.prototype.onAjaxSuccess = function(event, context, data) {
    ...
    CalendarPage.prototype.onBeforeSaveContent = function(e, data) {
     ...
     */
    CalendarPage.prototype.setPageTitle = function(title) {
     ...
     */
    CalendarPage.prototype.updateObjectList = function(objectType) {
     ...
     */
    CalendarPage.prototype.closeTabs = function(data, type) {
        var self = this
     ...
     */
    CalendarPage.prototype.onSidebarItemClick = function(e) {
        var self = this,
     ...
     */
    CalendarPage.prototype.onSidebarSubmenuItemClick = function(e) {
     ...
     */
    CalendarPage.prototype.onDeleteObject = function(e) {
        var $el = $(e.target),
     ...
     */
    CalendarPage.prototype.onLayoutChanged = function(e) {
        var
            self = this,
            $el = $(e.target),
            $form = $el.closest('form'),
     ...
     */
    CalendarPage.prototype.onInitTab = function(e, data) {
     ...
     */
    CalendarPage.prototype.onSaveMenu = function(e, data) {
        var form = e.currentTarget,
            items = [],
     ...
     */
    CalendarPage.prototype.updateContentEditorMode = function(pane, initialization) {
     ...
     */
    CalendarPage.prototype.getContentExtension = function(form) {
    ...
    $(document).ready(function(){
        $.oc.calendarPage = new CalendarPage()
    })
